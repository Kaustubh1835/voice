        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          ...
          {status === "authenticated" ? (
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <button onClick={() => router.push("/signin")} style={{ background: "transparent", border: "none", color: "var(--text-secondary)", fontSize: "13px", cursor: "pointer", fontWeight: 500 }} onMouseEnter={(e) => e.currentTarget.style.color = "var(--text-primary)"} onMouseLeave={(e) => e.currentTarget.style.color = "var(--text-secondary)"}>Log In</button>
              <button onClick={() => router.push("/signup")} style={{ padding: "7px 16px", background: "#3b82f6", color: "white", border: "none", borderRadius: "8px", fontSize: "12px", cursor: "pointer", fontWeight: 600 }}>Sign Up</button>
            </div>
          )}
        </div>
      </motion.nav>
